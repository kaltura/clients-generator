...
function gitCommit(gitPath) {
	...
	return execWithPomise(git + ` commit -m "Auto-generated by Jenkins job ${jenkins_job_name}/${jenkins_job_build_number}, branch ${branch}" `, gitPath);
}
...
function gitTagAndPush(gitPath) {
    if (process.argv.length>6)
    {
        ...
        return execWithPomise(git + ' push -f origin ' + branch, gitPath);
    }
}
