...
require_once (__DIR__ . '/ngx/GeneratedFileData.php');
require_once (__DIR__ . '/ngx/KalturaServerMetadata.php');
require_once (__DIR__ . '/ngx/ClassesGenerator.php');
require_once (__DIR__ . '/ngx/EnumsGenerator.php');



class NGXClientGenerator extends ClientGeneratorFromXml
{
	protected $_baseClientPath = "src/api";
	protected $_usePrivateAttributes;
	private $serverMetadata;

	function __construct($xmlPath, Zend_Config $config, $sourcePath = "ngx")
	{
