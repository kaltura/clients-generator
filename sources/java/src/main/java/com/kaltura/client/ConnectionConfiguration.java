...
public class ConnectionConfiguration implements Serializable {
	...
	public final static String ServiceResponseTypeFormat = "responseTypeFormat";
	...
	private void initDefaults() {
		...
		params.put(AcceptGzipEncoding, true);
		params.put(ServiceResponseTypeFormat, KalturaServiceResponseTypeFormat.RESPONSE_TYPE_JSON.getValue());
	}
	...
	public void setServiceResponseTypeFormat(KalturaServiceResponseTypeFormat format) {
		params.put(ServiceResponseTypeFormat, format.getValue());
	}
