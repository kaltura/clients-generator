...
abstract public class KalturaClientBaseApache implements Serializable {
	...
	protected Map<String, Object> clientConfiguration = new HashMap<String, Object>(); // generated by php script from input file
	protected Map<String, Object> requestConfiguration = new HashMap<String, Object>(); // generated by php script from input file

	private static IKalturaLogger logger = KalturaLogger.getLogger(KalturaClientBaseApache.class);
	 ...
	 * @see #isGzipResponse
	 * @see GZIPInputStream
	 * @see HttpPost#getEntity().getContent()
	 * @see HttpPost#getFirstHeader(String)
	 */
    ...
    public KalturaClientBaseApache() {
    }

    public KalturaClientBaseApache(KalturaConfiguration config) {
	...
	//!! should be changed - we're using ApiRequestsExecutor
