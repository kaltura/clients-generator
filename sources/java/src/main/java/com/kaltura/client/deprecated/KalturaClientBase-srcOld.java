...
abstract public class KalturaClientBase implements Serializable {
    ...
    public KalturaClientBase(ActionsQueue actionsQueue, KalturaConfiguration config) {
    	mActionsQueue = actionsQueue;
	...
	public Element doQueueOld() throws KalturaAPIException {
