...
This client library replaces the older architecture that presented in previous node.js client librariy (https://github.com/kaltura/KalturaGeneratedAPIClientsNodeJS).
