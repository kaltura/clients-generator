...
export class KalturaClientModule {
    ...
    static forRoot(clientOptionsFactory?: () => KalturaClientOptions, defaultRequestOptionsArgsFactory?: () => KalturaRequestOptionsArgs): ModuleWithProviders<KalturaClientModule> {
        return {
            ...
            providers: [
                ...
                defaultRequestOptionsArgsFactory ? {
