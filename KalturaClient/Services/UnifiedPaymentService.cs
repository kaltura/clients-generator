...
namespace Kaltura.Services
{
	public class UnifiedPaymentGetNextRenewalRequestBuilder : RequestBuilder<UnifiedPaymentRenewal>
	{
		...
		public UnifiedPaymentGetNextRenewalRequestBuilder(int id)
			: this()
		{
			this.Id = id;
		}
		...
		{
			return ObjectFactory.Create<UnifiedPaymentRenewal>(result);
		}
		public override object DeserializeObject(object result)
		{
			return ObjectFactory.Create<UnifiedPaymentRenewal>((IDictionary<string,object>)result);
		}
	}
	...
	public class UnifiedPaymentService
	{
		...
		{
			return new UnifiedPaymentGetNextRenewalRequestBuilder(id);
		}
	}
}
