...
namespace Kaltura.Services
{
	public class UserAssetRuleListRequestBuilder : RequestBuilder<ListResponse<UserAssetRule>>
	{
		...
		public UserAssetRuleListRequestBuilder(UserAssetRuleFilter filter)
			: this()
		{
			this.Filter = filter;
		}
		...
		{
			return ObjectFactory.Create<ListResponse<UserAssetRule>>(result);
		}
		public override object DeserializeObject(object result)
		{
			return ObjectFactory.Create<ListResponse<UserAssetRule>>((IDictionary<string,object>)result);
		}
	}
	...
	public class UserAssetRuleService
	{
		...
		{
			return new UserAssetRuleListRequestBuilder(filter);
		}
	}
}
