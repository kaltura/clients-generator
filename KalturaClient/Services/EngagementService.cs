...
namespace Kaltura.Services
{
	public class EngagementAddRequestBuilder : RequestBuilder<Engagement>
	{
		...
		{
			return ObjectFactory.Create<Engagement>((IDictionary<string,object>)result);
		}
	}
	...
	public class EngagementListRequestBuilder : RequestBuilder<ListResponse<Engagement>>
	{
		...
		public override object DeserializeObject(object result)
		{
			return ObjectFactory.Create<ListResponse<Engagement>>((IDictionary<string,object>)result);
		}
	}
