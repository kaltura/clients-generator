...
// BEO-9522 csharp2 before comment
	public class TvmRuleListRequestBuilder : RequestBuilder<ListResponse<TvmRule>>
	{
		...
		public TvmRuleListRequestBuilder(TvmRuleFilter filter)
			: this()
		{
			this.Filter = filter;
		}
		...
		{
			return ObjectFactory.Create<ListResponse<TvmRule>>(result);
		}
	}
...
// BEO-9522 csharp2 before comment
		...
		{
			return new TvmRuleListRequestBuilder(filter);
		}
	}
}
