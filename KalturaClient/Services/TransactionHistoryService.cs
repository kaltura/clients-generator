...
namespace Kaltura.Services
{
	public class TransactionHistoryListRequestBuilder : RequestBuilder<ListResponse<BillingTransaction>>
	{
		...
		public TransactionHistoryListRequestBuilder(TransactionHistoryFilter filter, FilterPager pager)
			: this()
		{
			this.Filter = filter;
			this.Pager = pager;
		...
		{
			return ObjectFactory.Create<ListResponse<BillingTransaction>>(result);
		}
		public override object DeserializeObject(object result)
		{
			return ObjectFactory.Create<ListResponse<BillingTransaction>>((IDictionary<string,object>)result);
		}
	}
	...
	public class TransactionHistoryService
	{
		...
		{
			return new TransactionHistoryListRequestBuilder(filter, pager);
		}
	}
}
