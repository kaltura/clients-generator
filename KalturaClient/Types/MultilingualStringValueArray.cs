...
{
	public class MultilingualStringValueArray : ObjectBase
	{
		#region Constants
		...
		private IList<MultilingualStringValue> _Objects;
		#endregion

		#region Properties
		public IList<MultilingualStringValue> Objects
		{
			get { return _Objects; }
			set 
			{ 
		...
		public MultilingualStringValueArray(XmlElement node) : base(node)
		{
			foreach (XmlElement propertyNode in node.ChildNodes)
			{
				switch (propertyNode.Name)
				{
					case "objects":
						...
						{
							this._Objects.Add(ObjectFactory.Create<MultilingualStringValue>(arrayNode));
						}
						continue;
				}
			}
		...
		public override Params ToParams(bool includeObjectType = true)
		{
			...
			if (includeObjectType)
				kparams.AddReplace("objectType", "KalturaMultilingualStringValueArray");
