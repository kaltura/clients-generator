...
{
	public class SegmentAllValues : SegmentValues
	{
		#region Constants
		public const string NAME_FORMAT = "nameFormat";
		#endregion
		...
		public override Params ToParams(bool includeObjectType = true)
		{
			...
			if (includeObjectType)
				kparams.AddReplace("objectType", "KalturaSegmentAllValues");
			kparams.AddIfNotNull("nameFormat", this._NameFormat);
			return kparams;
		}
