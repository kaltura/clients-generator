...
{
	public class EntitlementDiscountDetails : ObjectBase
	{
		#region Constants
		...
		public EntitlementDiscountDetails(JToken node) : base(node)
		{
			if(node["amount"] != null)
			{
		...
		public override Params ToParams(bool includeObjectType = true)
		{
			...
			if (includeObjectType)
				kparams.AddReplace("objectType", "KalturaEntitlementDiscountDetails");
