...
{
	public class ConfigurationGroupTagFilter : Filter
	{
		#region Constants
		...
		private ConfigurationGroupTagOrderBy _OrderBy = null;
		#endregion
		...
		public override Params ToParams(bool includeObjectType = true)
		{
			...
			if (includeObjectType)
				kparams.AddReplace("objectType", "KalturaConfigurationGroupTagFilter");
