...
namespace Kaltura.Types
{
	...
	{
		#region Constants
		public const string EVENT_OBJECT = "eventObject";
		#endregion
		...
		{
			if(node["eventObject"] != null)
			{
				this._EventObject = ObjectFactory.Create<EventObject>(node["eventObject"]);
			}
		}
		#endregion
		...
		public override Params ToParams(bool includeObjectType = true)
		{
			...
			kparams.AddIfNotNull("eventObject", this._EventObject);
			return kparams;
		}
