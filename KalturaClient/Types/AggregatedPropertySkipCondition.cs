...
{
	public class AggregatedPropertySkipCondition : PropertySkipCondition
	{
		#region Constants
		...
		private AggregationType _AggregationType = null;
		#endregion
		...
		public override Params ToParams(bool includeObjectType = true)
		{
			...
			if (includeObjectType)
				kparams.AddReplace("objectType", "KalturaAggregatedPropertySkipCondition");
			kparams.AddIfNotNull("aggregationType", this._AggregationType);
			return kparams;
		}
