...
{
	public class PlaybackProfile : ObjectBase
	{
		#region Constants
		...
		public PlaybackProfile(XmlElement node) : base(node)
		{
		...
		public PlaybackProfile(IDictionary<string,object> data) : base(data)
		{
		...
		public override Params ToParams(bool includeObjectType = true)
		{
			...
			if (includeObjectType)
				kparams.AddReplace("objectType", "KalturaPlaybackProfile");
