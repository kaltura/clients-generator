...
{
	public class AggregationCountFilter : RelatedObjectFilter
	{
		#region Constants
		...
		private AggregationCountOrderBy _OrderBy = null;
		#endregion
		...
		public override Params ToParams(bool includeObjectType = true)
		{
			...
			if (includeObjectType)
				kparams.AddReplace("objectType", "KalturaAggregationCountFilter");
