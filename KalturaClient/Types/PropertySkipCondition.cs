...
{
	public class PropertySkipCondition : SkipCondition
	{
		#region Constants
		...
		private SkipOperators _Operator = null;
		...
		public override Params ToParams(bool includeObjectType = true)
		{
			...
			if (includeObjectType)
				kparams.AddReplace("objectType", "KalturaPropertySkipCondition");
			kparams.AddIfNotNull("propertyPath", this._PropertyPath);
