...
{
	public class PurchaseSettings : Pin
	{
		#region Constants
		...
		private PurchaseSettingsType _Permission = null;
		#endregion
		...
		public override Params ToParams(bool includeObjectType = true)
		{
			...
			if (includeObjectType)
				kparams.AddReplace("objectType", "KalturaPurchaseSettings");
			kparams.AddIfNotNull("permission", this._Permission);
			return kparams;
		}
