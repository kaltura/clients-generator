...
{
	public sealed class RuleType : StringEnum
	{
		public static readonly RuleType PARENTAL = new RuleType("parental");
		public static readonly RuleType GEO = new RuleType("geo");
