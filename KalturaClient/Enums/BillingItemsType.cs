...
{
	public sealed class BillingItemsType : StringEnum
	{
		public static readonly BillingItemsType UNKNOWN = new BillingItemsType("unknown");
		public static readonly BillingItemsType PPV = new BillingItemsType("ppv");
		public static readonly BillingItemsType SUBSCRIPTION = new BillingItemsType("subscription");
