...
namespace Kaltura.Enums
{
	public sealed class NotificationType : StringEnum
	{
		...
		public static readonly NotificationType REMINDER = new NotificationType("Reminder");
		public static readonly NotificationType SERIES_REMINDER = new NotificationType("series_reminder");
