...
namespace Kaltura.Enums
{
	public sealed class ApiParameterPermissionItemAction : StringEnum
	{
		...
		public static readonly ApiParameterPermissionItemAction WRITE = new ApiParameterPermissionItemAction("WRITE");
		public static readonly ApiParameterPermissionItemAction ALL = new ApiParameterPermissionItemAction("ALL");
