...
namespace Kaltura.Enums
{
	...
	{
		public static readonly DrmSchemeName PLAYREADY_CENC = new DrmSchemeName("PLAYREADY_CENC");
		public static readonly DrmSchemeName WIDEVINE_CENC = new DrmSchemeName("WIDEVINE_CENC");
