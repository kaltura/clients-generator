...
namespace Kaltura
{
    public class ClientUtils
    {
        ...
        public string GenerateSession(int partnerId, string adminSecretForSigning, string userId = "", int expiry = 86400, string privileges = "")
        {
            return GenerateSessionV2(partnerId, adminSecretForSigning, userId, expiry, privileges);
        }
